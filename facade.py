...
class Facade:
    ...
    def update_req(self, id, code, date, time, client, service, status, date2, rent, emp):
        ...
        :return: None
        """
        self.db.update_req(id, code, date, time, client, service, status, date2, rent, emp)
    ...
    def read_requests(self):
        return self.db.select_requests()
    ...
    def get_req_serv(self):
        return self.db.get_req_serv()

    def get_req_count(self):
        return self.db.get_req_count()
